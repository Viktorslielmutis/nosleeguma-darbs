                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            $login_err = "Nederīgs lietotājvārds vai parole.";
                        }
                    }
                } else {
                    $login_err = "Nederīgs lietotājvārds vai parole.";
        ...
        <div class="back">
            <div class="login">
                ...
                if (isset($_SESSION["success_message"])) {
                    ...
                    // Unset the success message so it does not show again
                ...
                <form class="formloginreg" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="username">
                        <i class="fa fa-user" aria-hidden="true"></i>
                            <input placeholder="Lietotājvārds" name="username" type="text" class="input-field <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>" >
                            <span class="help-block"><?php echo $username_err; ?></span>
                    </div>

                    <div class="username">
                        <i class="fa fa-lock"></i>
                            <input placeholder="Parole" name="password" type="password" class="input-field <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" >
                            <span class="help-block"><?php echo $password_err; ?></span>
                    </div>

                    <div class="button">
                        <input type="submit" id="btn" value="Ienākt">
                    </div>
