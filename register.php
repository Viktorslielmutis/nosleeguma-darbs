            ...
            <div class="login">
                <form class="formloginreg" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <i class="fa fa-lock"></i>
                        <input type="password" placeholder="Passowrd" name="password" class="input-field <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>">
                        <span class="invalid-feedback"><?php echo $password_err; ?></span>
                    </div>
                    <div class="username">
                    <i class="fa fa-lock"></i>
                        <input type="password" placeholder="Confirm password" name="confirm_password" class="input-field <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
                        <span class="invalid-feedback"><?php echo $confirm_password_err; ?></span>
                    </div>
                    <div class="button">
                        <input type="submit" id="btn" value="Submit">
                    </div>
                    <div class="teksts1">Ir jau esošs konts?<a href="login.php">login in</a></div>
                </form>
            </div>
        </div>   
    </div>
